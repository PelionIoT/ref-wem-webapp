...
class MBEDCloudSession(requests.Session):
    ...
    https://cloud.mbed.com/docs/v1.2/api-references/connect-api.html
    ...
    """https://cloud.mbed.com/docs/v1.2/api-references/connect-api.html#v2-notification-callback"""
    ...
    """https://cloud.mbed.com/docs/v1.2/api-references/connect-api.html#v2-subscriptions"""
