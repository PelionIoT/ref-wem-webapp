...
We have tested this on the [Debian 9 operating system on an Amazon EC2 instance](https://wiki.debian.org/Cloud/AmazonEC2Image/Stretch).  On us-east-1, we use ami-b4fd39c9.  Make sure you've allowed HTTP(port 80) in your EC2 security group.
